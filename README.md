...
- Timestamp: `2022-05-21 08:54`
- Build ID: `5e44342d-2d5e-4b58-abb4-809093426161`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5e44342d-2d5e-4b58-abb4-809093426161.git
$ cd 5e44342d-2d5e-4b58-abb4-809093426161
```
